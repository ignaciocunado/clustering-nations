...
chain = sample(semi_parametric_approach(X, Y, n_i, n, grouped_X, grouped_Y), PG(15), 1000, discard=100)
...
# coefficients_chain = sample(retrieve_coefficients(X, Y, n_i, n, grouped_X, grouped_Y, bestclust), PG(20), 3000, discard=500)
